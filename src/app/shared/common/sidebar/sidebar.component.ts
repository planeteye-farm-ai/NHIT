...
export class SidebarComponent {
  ...
  constructor(
    ...
    this.access_type = localStorage.getItem('role');
  ...
  ngOnInit() {
    if(this.access_type === 'Bridge Site Engineer')
    {
      this.menuitemsSubscribe$ = this.navServices.BridgeSiteEnggMenu.subscribe((BridgeSiteEnggMenu) => {
        this.menuItems = BridgeSiteEnggMenu;
      });
    }else if(this.access_type === 'Road Site Engineer'){
      this.menuitemsSubscribe$ = this.navServices.RoadSiteEnggMenu.subscribe((RoadSiteEnggMenu) => {
        this.menuItems = RoadSiteEnggMenu;
      })
    }
    else if(this.access_type === 'Senior Management'){
      this.menuitemsSubscribe$ = this.navServices.SeniorManagementMenu.subscribe((SeniorManagementMenu) => {
        this.menuItems = SeniorManagementMenu;
      })
    }
    else{
