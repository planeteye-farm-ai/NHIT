...
export class NavService implements OnDestroy {
  ...
  public BridgeSiteEngg: Menu[] = [];
  public RoadSiteEngg: Menu[] = [];
  public SeniorManagement: Menu[] = [];
  ...
  private loadMenuItems(): void {   
            ...
            { headTitle: 'Reports' },
            {
              ...
              active: false,
               children: [
                ...
                {
                  title: 'Distress Reported Report',
                  dirchange: false,
                  type: 'link',
                  active: false,
                  selected: false,
                  path: '/reports/distress-reported-report',
                },
                 {
                  title: 'Distress Prediction Report',
                  dirchange: false,
                  type: 'link',
                  active: false,
                  selected: false,
                  path: '/reports/distress-prediction-report',
                },
              ]
          ...
          this.BridgeSiteEnggMenu.next(this.BridgeSiteEngg);
          this.RoadSiteEnggMenu.next(this.RoadSiteEngg);
          this.SeniorManagementMenu.next(this.SeniorManagement);

          
  }
  
  items = new BehaviorSubject<Menu[]>(this.MENUITEMS);
  BridgeSiteEnggMenu = new BehaviorSubject<Menu[]>(this.BridgeSiteEngg);
  RoadSiteEnggMenu = new BehaviorSubject<Menu[]>(this.RoadSiteEngg);
  SeniorManagementMenu = new BehaviorSubject<Menu[]>(this.SeniorManagement);
