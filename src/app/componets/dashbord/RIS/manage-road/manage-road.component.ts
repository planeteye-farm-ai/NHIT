...
export class ManageRoadComponent {
  ...
  constructor(config: NgbModalConfig, private modalService: NgbModal,private toastr: ToastrService,private roadService:RoadService) {
  ...
  delete(){
    if (this.selectedId !== null) {
      this.roadService.deleteRoad(this.selectedId).subscribe((res)=>{
