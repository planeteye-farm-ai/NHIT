  ...
  implements OnInit, AfterViewInit, OnDestroy
{
  ...
  openChainageComparisonModal() {
    ...
    setTimeout(() => {
      ...
      console.log('✅ RIS Reported: Generated chainage comparison chart');
    }, 100);
    
    console.log('✅ RIS Reported: Opened chainage comparison chart modal with distresses:', this.selectedDistressesForComparison);
  }
  ...
  closeChainageComparisonModal() {
    ...
    console.log('✅ RIS Reported: Closed chainage comparison chart modal');
  }
  ...
  toggleDistressForComparison(distressName: string) {
    ...
    console.log('✅ RIS Reported: Selected distresses for comparison:', this.selectedDistressesForComparison);
  ...
  generateChainageComparisonChart() {
    ...
    console.log('✅ RIS Reported: Generated chainage comparison chart with', series.length, 'distresses');
  }
